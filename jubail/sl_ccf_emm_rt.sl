#!/bin/bash
#SBATCH --job-name=ccf_emm_rt
#SBATCH --mem=400GB  # only set this when the memory is larger than 4GB
#SBTACH --workdir=/scratch/hj23/2faces/jubail
#SBATCH --time=1-00:00:00
#SBATCH --mail-type=end  # ALL     start,end
#SBATCH --mail-user=haiyang.jin@nyu.edu
#SBATCH -o job.emm.ccf.rt.%J.out  ## #SBATCH -o %A_%a
