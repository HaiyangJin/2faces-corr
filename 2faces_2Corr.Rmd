...
Correlations among holsitic effects (accuracy or d' with subtraction):
```{r}
...
Correlations among holsitic effects (RT):
```{r}
corPlot(hpe_rt_subt)
```
...
Correlations among holsitic effects (accuracy or d' with regression):
```{r}
...
Correlations among holsitic effects (RT with regression):
```{r}
corPlot(hpe_rt_regr)
```
