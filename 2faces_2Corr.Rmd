...
## Comparing correlations (non-preregistered)

```{r}
library(cocor)
```

### r(CCF,SCF) vs. r(interference,SCF)
...
### r(SCF,interference) vs. r(SCF,facilitation)
...
### r(SCF,interference) vs. r(PW,interference)
...
### r(PW,facilitation) vs. r(PW,interference)
...
### r(PW,facilitation) vs. r(SCF,facilitation)
...
## Correlations between facilitation and interference (non-preregistered)

### With isolated as baseline
...
```{r}
cor.test(con_simu, iso_simu)
```

```{r}
cor.test(inc_simu, iso_simu)
```
...
ggsave(filename = here("figures","fig_cor_facilitation.pdf"), 
       fig_corr_faci, width = 9, height = 9*1)
```
...
ggsave(filename = here("figures","fig_cor_interference.pdf"), 
       fig_corr_inte, width = 9, height = 9*1)
```
