...
```{r}
rel_pwe_acc_subt <- rel_sub(rel_pw_acc_w$Reliability, rel_pw_acc_p$Reliability,
...
```{r}
rel_pwe_acc_regr <- rel_reg(rel_pw_acc_w$Reliability, rel_pw_acc_p$Reliability,
                            pwe_acc$whole, pwe_acc$part) %>% 
  tibble(DV = "acc", Condition = "whole ~ part", 
...
Subtraction of RT
```{r}
rel_pwe_rt_subt <- rel_sub(rel_pw_rt_w$Reliability, rel_pw_rt_p$Reliability,
...
Regression of RT
```{r}
rel_pwe_rt_regr <- rel_reg(rel_pw_rt_w$Reliability, rel_pw_rt_p$Reliability,
                           pwe_rt$whole, pwe_rt$part) %>% 
  tibble(DV = "rt", Condition = "whole ~ part", 
         Approach = "Regression", Reliability = .)
rel_pwe_rt_regr
...
```{r}
bind_rows(rel_pw_acc_w, rel_pw_acc_p, rel_pw_rt_w, rel_pw_rt_p,
