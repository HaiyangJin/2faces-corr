...
```{r}
psych_cor1(pwe_acc$pwe_subt, ccfe_d$fac_subt)
```
...
```{r}
psych_cor1(pwe_acc$pwe_subt, ccfe_d$fac_subt_iso)
```
...
```{r}
psych_cor1(pwe_rt$pwe_subt, ccfe_rt$fac_subt)
```
...
```{r}
psych_cor1(pwe_rt$pwe_subt, ccfe_rt$fac_subt_iso)
```
...
```{r}
psych_cor1(pwe_acc$pwe_regr, ccfe_d$fac_regr)
```
...
```{r}
psych_cor1(pwe_acc$pwe_regr, ccfe_d$fac_regr_iso)
```
...
```{r}
psych_cor1(pwe_rt$pwe_regr, ccfe_rt$fac_regr)
```
...
```{r}
psych_cor1(pwe_rt$pwe_regr, ccfe_rt$fac_regr_iso)
```
...
```{r}
psych_cor1(scfe_acc$scfe_subt, ccfe_d$int_subt)
```
...
```{r}
psych_cor1(scfe_acc$scfe_subt, ccfe_d$int_subt_iso)
```
...
```{r}
psych_cor1(scfe_rt$scfe_subt, ccfe_rt$int_subt)
```
...
```{r}
psych_cor1(scfe_rt$scfe_subt, ccfe_rt$int_subt_iso)
```
...
```{r}
psych_cor1(scfe_acc$scfe_regr, ccfe_d$int_regr)
```
...
```{r}
psych_cor1(scfe_acc$scfe_regr, ccfe_d$int_regr_iso)
```
...
```{r}
psych_cor1(scfe_rt$scfe_regr, ccfe_rt$int_regr)
```
...
```{r}
psych_cor1(scfe_rt$scfe_regr, ccfe_rt$int_regr_iso)
```
